...
public class Solution {
    ...
    public static void changeObject(int[] array) {
        ...
        System.out.println("Значение всех элементов массива array внутри метода changeObject(int[]) равно "
    ...
    public static void main(String[] args) {
        ...
        int[] array = { 1, 2, 3, 4, 5 };
        System.out.println("Значения всех элементов массива array до вызова метода changeObject(int[]) равно "
                + Arrays.toString(array));
        changeObject(array);
        System.out.println("Значение всех элементов массива array после вызова метода changeObject(int[]) равно "
                + Arrays.toString(array));
    }
}
